...
const OnboardingFlow: React.FC<OnboardingFlowProps> = ({ onComplete }) => {
  ...
  const renderVisual = (slide: OnboardingSlide) => {
    // Balanced visual representations for better UX
    switch (slide.type) {
      case 'welcome':
        return (
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
             <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 h-[650px] md:h-[700px] overflow-hidden">
        {/* Progress Bar */}
        ...
        <div className="p-4 md:p-6 flex flex-col h-full">
          {/* Visual - Balanced size */}
          <div className="flex-shrink-0 mb-3">
            {renderVisual(currentSlide)}
          </div>

          {/* Description - Better readable */}
          ...
          {/* Slide Navigation - Better spacing */}
