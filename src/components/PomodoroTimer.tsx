...
import { Play, Pause, RotateCcw, X, Brain, Target, AlertTriangle, Trophy, Zap } from 'lucide-react';
...
const PomodoroTimer: React.FC<PomodoroTimerProps> = ({ 
  ...
  const handleObstacleSubmit = useCallback(() => {
    if (obstacleInput.trim() && emotionalState.trim()) {
      // Here you would typically send this to an AI service for real-time resolution
      console.log('Obstacle submitted:', { obstacle: obstacleInput, emotionalState });
      setObstacleInput('');
      setEmotionalState('');
      setShowObstacleResolver(false);
    }
  }, [obstacleInput, emotionalState]);
      ...
      <div className="fixed inset-0 bg-black/80 backdrop-blur-xl z-50 flex items-center justify-center p-4">
        <div className="bg-gray-900/95 border border-gray-700/50 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-white mb-2">🚀 Task Execution Protocol</h2>
          ...
          {/* Motivation Tracking */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-white mb-4">🧠 Motivation Tracking</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-400 mb-2">Motivation Before (1-10)</label>
                <select
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Motivation After (1-10)</label>
                <select
